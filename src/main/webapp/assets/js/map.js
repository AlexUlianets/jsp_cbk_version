...
app.controller('MapMarkerCtrl', function ($scope, $element, mapMarkerConstructor) {
    ...
    GoogleOverlayView.prototype.draw = function () {
        ...
        this.element[0].innerHTML = "<img src='svg/wicons_svg_white/" + this.img + "_" + this.day + ".svg' alt=''>" + "<h5>" + this.temp + " <span>" + this.typeTemp + "</span><h5></h5><span class='map-city'>" + this.city + "</span>";
