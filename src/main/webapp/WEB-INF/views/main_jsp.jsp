...
<head>
    ...
    <meta property="og:url" content="http://<%=request.getServerName()%>:<%=request.getServerPort()%>${requestScope['javax.servlet.forward.request_uri']}"/>
    ...
    <section id="${pageName == '/' || fn:length(fn:split(pageName, "/")) == 3 ? 'top-main' : 'top-page'}" >
        ...
        <div class="container" style="visibility: hidden">
            ...
            <div class="h-full-forecast" ng-if="$state.params.day=='front-page'">
                <div class="container">
                    <a href="{{origin}}/{{currentCountryCode}}/weather/today/{{selectedCity}}"> {{pageContent.fullForecast}}<span class="arr-right-white"></span></a>
                </div>
            </div>
        </div><!-- end container -->
